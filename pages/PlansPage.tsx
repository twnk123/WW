...
const PlansPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-bg overflow-hidden">
            <Seo
                title={`Web Development Pricing | MVP Packages from $275 | WHITEWEAVER`}
                description={`Transparent, fixed-price web development for startups. Packages from $275-$2,400. MVP, e-commerce, custom apps. 5-day delivery. Money-back guarantee. No hidden fees.`}
                canonical="/plans"
                type="product"
                alternates={[
