...
const ContactPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen overflow-hidden bg-gradient-to-b from-transparent via-accent/5 to-transparent">
            <Seo
                title={`Contact Us | Get Free Strategy Session | WHITEWEAVER`}
                description={`Start your MVP project today. Free 15-minute strategy session. Fixed pricing from $275. 5-day delivery. Money-back guarantee. Contact WHITEWEAVER's AI development team now.`}
                canonical="/contact"
                alternates={[
                            ...
                            <ScrollReveal delay={0.2}>
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="starter">Starter - $275</option>
                                        <option value="pro">Pro - $1,200</option>
                                        <option value="scale">Scale - $2,400</option>
