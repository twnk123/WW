  ...
  return (
    <div className="min-h-screen overflow-hidden">
      <Seo
        ...
        description={`View our portfolio of AI-built websites and MVPs. Real case studies from $275-$2,400 packages. Coffee shops, gyms, e-commerce, fashion brands. See what's possible.`}
        canonical="/work"
        alternates={[
                      ...
                      <div className="relative overflow-hidden rounded-2xl md:rounded-3xl bg-button-bg">
                        ...
                        <div className="relative aspect-[16/9] md:aspect-[21/9] overflow-hidden">
                          <motion.img
                            ...
                            alt={`${project.title} - ${project.tag} web development case study by WHITEWEAVER`}
                      ...
                      <div className={`grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-center ${isReverse ? 'md:flex-row-reverse' : ''}`}>
                        ...
                        <div className={`md:col-span-7 ${isReverse ? 'md:col-start-6' : ''}`}>
                          ...
                          >
                            <img
                              src={project.coverImage}
                              alt={`${project.title} - ${project.tag} project portfolio showcase`}
