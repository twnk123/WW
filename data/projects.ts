...
export const projects: Project[] = [
  {
    ...
    description: 'A clean, professional website for a local coffee shop. This project showcases what our €200 package includes: responsive design, essential pages, contact forms, and basic SEO setup. Perfect for small businesses looking to establish their online presence.',
  ...
  },
  {
    ...
    description: 'A comprehensive fitness website showcasing our €700 package capabilities. Features include class scheduling, trainer profiles, membership plans, and interactive elements. Perfect for businesses requiring complex functionality and user engagement.',
