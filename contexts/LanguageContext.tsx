  ...
  en: {
    ...
    services: {
      ...
      faqs: [
        ...
        },
        {
          ...
          a: 'Website projects typically range from $275 for simple sites to $2,400 for more complex projects. We provide detailed quotes based on your specific requirements and can work within your budget constraints.'
        },
        {
    ...
    plans: {
      ...
      stats: [
        ...
        { value: '$275', label: 'Starting Price' }
      ],
      faq: {
        title: 'Frequently Asked Questions',
